const questions = [
    ...
    },
    {
      ...
      type: "radio",
      options: [
        { label: "Bypass it", value: "bypass" },
        { label: "Knock before going in", value: "knock" },
        { label: "Rush in", value: "rushIn" }
      ],
      explanation: {
    ...
    {
      id: 8,
      text: "How much water is in this jug?",
      type: "radio",
      options: [
        { label: "No water", value: "no water" },
        { label: "1/2 full", value: "1/2 full" },
        { label: "3/4 full", value: "3/4 full" },
        { label: "Totally full", value: "totally full" }
      ],
      explanation: {
    ...
    {
      id: 11,
      text: "Now you've reached the river bank, and your destination is just opposite. How do you go over?",
      type: "radio",
      options: [
        { label: "Jump into the river and swim across", value: "jump" },
        { label: "Find another way to cross it", value: "find another way" }
      ],
      explanation: {
